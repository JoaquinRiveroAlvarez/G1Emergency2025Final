...
namespace Proyecto2025.Server.Controllers
{
    ...
    public class HistoricoController : ControllerBase
    {
        ...
        [HttpGet("ListaHistorico")]
        public async Task<ActionResult<List<HistoricoListadoDTO>>> GetListaHistorico()
        {
            var lista = await repositorio.SelectListaHistorico();
            if (lista == null)
            {
                return NotFound("No se encontro la lista, VERIFICAR.");
            }
        ...
        [HttpPost("entrada")]
        public async Task<IActionResult> RegistrarEntrada(int tripulanteId, int movilId)
        {
            try
            {
                await repositorio.RegistrarEntrada(tripulanteId, movilId);
        ...
        [HttpPost("salida")]
        public async Task<IActionResult> RegistrarSalida(int tripulanteId, int movilId)
        {
            try
            {
                await repositorio.RegistrarSalida(tripulanteId, movilId);
